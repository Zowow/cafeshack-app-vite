...
function Hero() {
    return (
        <div className="lg:h-1/2 relative">
            ...
            <div className="
                    ...
                    <div className="box
                        ...
                        <p className="text-center text-md font-[Poppins]">
                            Indulge in our meticulously crafted selection of premium coffees.
                        </p>
                    </div>
                    <div className="box
                            w-[300px] h-48 shadow-custom flex items-center rounded-xl border-[1px] bg-white gap-4 p-4
                        ...
                        <p className="text-center text-md font-[Poppins]">
                            Savor a delectable array of carefully curated meals that cater to various tastes.
                        </p>
                    </div>
                    <div className="box
                            w-[300px] h-48 shadow-custom flex items-center rounded-xl border-[1px] bg-white gap-4 p-4
                        ...
                        <p className="text-center text-md font-[Poppins]">
                            Unwind and rejuvenate in our cozy lounge area designed for ultimate relaxation.
                        </p>
                    </div>

            </div>
            <div className="
                lg:bg-[url('./assets/hero-bg.svg')] lg:h-[360px] lg:w-[1038px] lg:mx-auto lg:relative
